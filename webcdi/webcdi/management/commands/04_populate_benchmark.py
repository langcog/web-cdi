        ...
        for curr_instrument in input_instruments:
            ...
            if ftype == "csv":
                ...
                contents = list(
                    unicode_csv_reader(
                        open(
                            os.path.realpath(
                                PROJECT_ROOT + "/" + curr_instrument["benchmark"]
                            ),
                            encoding="utf8",
                        )
                    )
            ...
            for row in range(1, nrows):
                ...
                if len(row_values) > 1:
                    ...
                    scoring_obj = InstrumentScore.objects.get(
                        title=title, instrument=instrument_obj
                    )
                    ...
                    cdi_item, created = Benchmark.objects.update_or_create(
                        instrument=instrument_obj,
                        instrument_score=scoring_obj,
