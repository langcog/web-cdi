...
class StudyAdmin(admin.ModelAdmin):
    list_display=['name','get_responses','instrument','researcher','demographic', 'share_opt_out', 'get_chargeable']
    list_filter = ['share_opt_out', ('researcher', DropdownFilter), 'instrument', ]
