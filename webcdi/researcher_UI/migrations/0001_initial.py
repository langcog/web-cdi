    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "administration",
                    models.ForeignKey(
                        to="researcher_UI.administration", on_delete=models.PROTECT
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                (
                    "name",
                    models.CharField(max_length=51, serialize=False, primary_key=True),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instrument",
                    models.ForeignKey(
                        to="researcher_UI.instrument", on_delete=models.PROTECT
                    ),
                ),
            ],
        ),
