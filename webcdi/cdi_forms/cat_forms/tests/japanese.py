...
class CATJapaneseAdministrationDataItemTest(TestCase):
    ...
    def test_japanese_start_values(self):
        self.start_values(
            f"{settings.BASE_DIR}/cdi_forms/cat_forms/tests/test_data/japanese_start.csv"
        )

    def test_japanese_seq_1(self):
        self.sequence_test(
            f"{settings.BASE_DIR}/cdi_forms/cat_forms/tests/test_data/japanese_sequence_1.csv"
        )
    ...
    def test_japanese_seq_2(self):
        ...
        self.backgroundinfo.save()
        self.sequence_test(
            f"{settings.BASE_DIR}/cdi_forms/cat_forms/tests/test_data/japanese_sequence_2.csv"
        )
