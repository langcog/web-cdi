...
urlpatterns = [
    ...
    path('background-create/<int:study_id>/bypass/', views.CATCreateBackgroundInfoView.as_view(), {'bypass':True}, name='create-new-background-info'),
    path('background-create/<int:study_id>/', views.CATCreateBackgroundInfoView.as_view(), {'bypass':None}, name='create-new-background-info'),
