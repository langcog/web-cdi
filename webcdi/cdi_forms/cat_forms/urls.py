...
urlpatterns = [
    ...
    path('background-create/<int:study_id>/bypass/(?P<source_id>[0-9a-zA-Z]+)/', views.CATCreateBackgroundInfoView.as_view(), {'bypass':True}, name='create-new-background-info'),
    path('background-create/<int:study_id>/(?P<source_id>[0-9a-zA-Z]+)/', views.CATCreateBackgroundInfoView.as_view(), {'bypass':None}, name='create-new-background-info'),
