...
urlpatterns = [
        ...
        url(r'^background-create/(?P<study_id>[0-9]+)/bypass/(?P<source_id>[0-9a-zA-Z]+)/$', views.CreateBackgroundInfoView.as_view(), {'bypass':True}, name='create-new-background-info'),
        url(r'^background-create/(?P<study_id>[0-9]+)/(?P<source_id>[0-9a-zA-Z]+)/$', views.CreateBackgroundInfoView.as_view(), {'bypass':None}, name='create-new-background-info'),
