...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='age',
            field=models.IntegerField(null=True, verbose_name=b'Age (in months)', blank=True),
        ),
        migrations.AlterField(
            model_name='backgroundinfo',
            name='due_date_diff',
            field=models.IntegerField(blank=True, null=True, verbose_name=b'By how many weeks?', validators=[django.core.validators.MinValueValidator(1, b'Number of weeks cannot be less than 1')]),
        ),
        migrations.AlterField(
            model_name='backgroundinfo',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(blank=True, null=True, verbose_name=b'How many days per week is the child exposed to these languages?', validators=[django.core.validators.MaxValueValidator(7, b'Number of days per week cannot exceed 7'), django.core.validators.MinValueValidator(1, b'Number of days per week cannot be less than 1')]),
        ),
        migrations.AlterField(
            model_name='backgroundinfo',
            name='language_from',
            field=models.CharField(max_length=50, null=True, verbose_name=b'From whom?', blank=True),
        ),
        migrations.AlterField(
            model_name='backgroundinfo',
            name='language_hours_per_day',
            field=models.IntegerField(blank=True, null=True, verbose_name=b'How many hours per day is the child exposed to these languages?', validators=[django.core.validators.MaxValueValidator(24, b'Number of hours per day cannot exceed 24'), django.core.validators.MinValueValidator(1, b'Number of hours per day cannot be less than 1')]),
        ),
        migrations.AlterField(
            model_name='backgroundinfo',
