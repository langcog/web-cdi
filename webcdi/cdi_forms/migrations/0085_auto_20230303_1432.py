...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), ("Don't know", "Don't know"), ('Prefer not to say', 'Prefer not to say')], max_length=51, null=True, verbose_name='Has your child been diagnosed with any troubles, for example, hearing, vision, speech, learning difficulty'),
        ),
