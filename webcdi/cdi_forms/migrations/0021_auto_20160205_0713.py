...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='birth_order',
            field=models.IntegerField(verbose_name=b'Birth order (enter number)', validators=[django.core.validators.MinValueValidator(1, b'Birth order cannot be less than 1. First born child gets value 1')]),
        ),
        migrations.AlterField(
            model_name='backgroundinfo',
            name='birth_weight',
